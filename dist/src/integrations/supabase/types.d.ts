...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            documents: {
                Row: {
                    anonymization_mode: Database["public"]["Enums"]["anonymization_mode"] | null;
                    contract_decision: Database["public"]["Enums"]["contract_decision"] | null;
        ...
        Enums: {
            ...
            contract_decision: "PROCESSING" | "AUTO_REDLINEDRAFT" | "ESCALATE_HUMAN" | "BLOCK_EXPORT" | "READY_FOR_EXPORT";
            document_status: "UPLOADING" | "UPLOADED" | "PROCESSING" | "PROCESSED" | "ERROR";
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly anonymization_mode: readonly ["OFF", "DISPLAY_ONLY", "FULL"];
            readonly app_role: readonly ["client", "firm_admin"];
            readonly clause_status: readonly ["SAFE", "RISK"];
            readonly client_state: readonly ["OK", "RECOMMENDED", "REQUIRED", "NEEDS_REVIEW", "BLOCKED"];
            readonly contract_decision: readonly ["PROCESSING", "AUTO_REDLINEDRAFT", "ESCALATE_HUMAN", "BLOCK_EXPORT", "READY_FOR_EXPORT"];
            readonly document_status: readonly ["UPLOADING", "UPLOADED", "PROCESSING", "PROCESSED", "ERROR"];
            readonly run_status: readonly ["PENDING", "RUNNING", "COMPLETED", "FAILED"];
        };
    };
};
export {};
