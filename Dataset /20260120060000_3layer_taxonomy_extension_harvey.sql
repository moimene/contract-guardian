...
-- Extends taxonomy with 6 new matters and 33+ new clause_types from Harvey dataset
...
DECLARE
  bp_version_id uuid;
BEGIN
  -- Get the Amazon Blueprint version
  ...
  IF bp_version_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'matter_policies created for new matters';
  ELSE
