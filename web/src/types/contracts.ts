...
export const CLAUSE_STATUS_CONFIG: Record<ClauseStatus, ClauseStatusConfig> = {
    OK: {
        ...
        description: 'This clause meets the requirements',
    },
    RECOMMENDED: {
        label: 'Recommended',
        icon: 'info',
        ...
        description: 'Optional improvements suggested',
    },
    REQUIRED: {
        ...
        description: 'Recommended to apply the proposed change',
    },
    NEEDS_REVIEW: {
        ...
        description: 'This clause requires manual review',
    },
    BLOCKED: {
        label: 'Blocked',
        icon: 'ban',
        ...
        description: 'This clause prevents export',
    },
}
