...
export type AnalysisMode =
    ...
    | 'MODE_ENUMERATED_DEVIATIONS'     // Only listed acceptable variations allowed
    | 'MODE_POLICY_JUDGMENT_REQUIRED'; // Agent judgment with escalation
