/**
 * ================================================================
 * HYBRID KEYWORD ROUTER v5.0 - CG-016 Enhanced
 * ================================================================
 ...
 * - PSA-specific payment terminology (fixes PaymentCredits)
 * - Procedural language patterns (fixes IndemnityProcedures)
 *
 * Version: 5.0
...
const ENHANCED_PATTERNS = {
    ...
    IndemnityProcedures: {
        ...
        tier3_keywords: ["notice", "defense", "settlement", "claim", "counsel"],
        negative: [],
        min_matches: 2,
